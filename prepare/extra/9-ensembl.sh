...
if [ ! -e /prepare/resource/ensembl-${ENSEMBL_VERSION}.tar.gz ]; then
...
echo "==> ensembl"
tar xfz /prepare/resource/ensembl-${ENSEMBL_VERSION}.tar.gz \
...
tar xfz /prepare/resource/ensembl-compara-${ENSEMBL_VERSION}.tar.gz \
...
tar xfz /prepare/resource/ensembl-variation-${ENSEMBL_VERSION}.tar.gz \
