...
then
    echo "==> download"
    cd /prepare/resource/
    wget -N https://fastdl.mongodb.org/osx/mongodb-osx-x86_64-3.0.7.tgz

    echo "==> untar"
    cd $HOME/share/
    tar xvfz /prepare/resource/mongodb-osx-x86_64-3.0.7.tgz
    ...
    echo "==> untar"
    cd $HOME/share/
    tar xvfz /prepare/resource/mongodb-linux-x86_64-ubuntu1404-3.0.7.tgz
