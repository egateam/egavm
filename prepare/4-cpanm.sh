...
# bioperl
cpanm --mirror-only --mirror http://mirrors.ustc.edu.cn/CPAN/ Data::Stag Test::Most URI::Escape
cpanm --mirror-only --mirror http://mirrors.ustc.edu.cn/CPAN/ Algorithm::Munkres Array::Compare Clone Error File::Sort Graph IO::Scalar List::MoreUtils Set::Scalar Sort::Naturally
